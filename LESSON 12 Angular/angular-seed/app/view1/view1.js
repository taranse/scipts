...
angular.module('myApp.view1', ['ngRoute'])
    ...
    .controller('View1Ctrl', function ($scope) {
        ...
        $scope.myOrderReverse = function(name){
			 if($scope.myOrderProperty == '!weight'){
...
.filter('filterClass', function(){
	return function(className){
		if(className[0] == 'fire') return 'red';
		else if(className[0] == 'water') return 'blue';
		else if(className[0] == 'grass') return 'green';
		else return '';
	}
})