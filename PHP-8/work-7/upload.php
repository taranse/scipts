...
if($_FILES['test']['type'] == 'application/octet-stream'){
	...
	header('location: http://university.netology.ru/user_data/plyakin/work-7/list.php');
}else{
	header('location: http://university.netology.ru/user_data/plyakin/work-7/admin.php?err=true');
}